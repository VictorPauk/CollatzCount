    ...
    , ui(new Ui::MainWindow)
{
    ...
    //connect(this,&MainWindow::stopSignal,collatzCounter,&CollatzCounter::SetStopSignal);
...
void MainWindow::on_Start_button_clicked()
{
    ...
    connect(this,&MainWindow::stopSignal,collatzCounter,&CollatzCounter::StopCalc);
    collatzCounter->moveToThread(threadUI);
